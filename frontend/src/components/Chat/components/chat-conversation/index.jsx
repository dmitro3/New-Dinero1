                ...
                <div className="min-w-0 flex-1">
                  <div className="flex gap-2 items-center">
                    {isEmailVerified && !isBot && (
                      <Image width={20} height={20} src={verified} alt="chat" />
                    )}
                    {isBot && (
                  ...
                  {messageType === 'CHAT_RAIN' ? (
                        ...
                        <Button
                          ...
                          className={`absolute left-1 mx-auto w-auto px-2 bottom-[18px] ${
                            isClosed || isUserClaimed
                              ? 'bg-[rgb(var(--lb-blue-100))] !cursor-not-allowed hover:bg-[rgb(var(--lb-blue-100))]'
                    ...
                    <div className="flex flex-col rounded-r-lg rounded-bl-lg mt-2.5 p-2 bg-[rgb(var(--lb-blue-600))]">
                      <div className="relative w-full">
                        ...
                        <p className="text-white whitespace-pre-wrap break-words [overflow-wrap:anywhere]">
                          {message}
                    ...
                    <div
                      className={`rounded-r-lg rounded-bl-lg mt-2.5 p-2 w-auto ${
                        isContainOffensiveWord
